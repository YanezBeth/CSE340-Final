...
<article class="mod-vehicle">
    <h1><?php if (isset($pageTitle)) {
            echo $pageTitle;
        } ?></h1>
    <p class="mod-vehicle-p">
        *All fields are required to modify a vehicle in PHP Motors
    </p>
    ...
    <div class="form-contain">
        <form action="/phpmotors/vehicles/" method="post">
            ...
            <br>
            <div class="form-row">
                <input type="submit" name="submit" id="mod-vehicles" value="Update Vehicle">
